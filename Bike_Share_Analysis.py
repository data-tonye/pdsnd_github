...
# 
# **Answer**: Which city has more existing customers? How much time are users spending using the system?
# 
...
# 
# **Answer**: Chicago has the highest number of trips. NYC has the highest proportion of trips made by subscribers at 88.84. Chicago has the highest proportion of trips made by short-term customers at 23.77.
...
# 
# **Answer**: The Average Length for Washington, Chicago and NYC is 18.93, 16.56 and 15.81. Proportion of riders made in Washington, Chicago and NYC longer than 30 minutes is 89.16, 91.67 and 92.70. NYC had the highest proportion of rides longer than 30 minutes and Washington had highest average trip length.
...
# 
# **Answer**: Average Subscriber trip time for Chicago is 12.07 and for Customers it's 30.98. Customers take more rides on average than subscribers.
...
# 
# **Answer**: For Chicago, the peak of the Subscriber distribution between 5 to 10 minutes and the peak of the Customer distribution is between 15 to 20 minutes. The shape of the Subscriber distribution can be described as a right-skewed distribution. In case Customer, the distribution is similar to that of the Subscriber as it's right-skewed but with higher spread of observations.
...
# 
# **Answer**: The histogram showed right-skewed distributions with peaks around 10 minutes for weekdays and weekends. It was observed that 17minutes was the average weekday trip time and  24 minutes was the average weekend trip time.
...
# 
# **Answer**: I will like to apply this as a prodeuct designer and would love to know how customers interact with my design or a service.
# 
